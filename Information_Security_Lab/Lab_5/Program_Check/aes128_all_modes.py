"""Demonstrate AES-128 in multiple modes: ECB, CBC, CFB, OFB, CTR, GCM.

Each mode performs an encrypt -> decrypt round-trip on a single 16-byte
plaintext and prints hex representations of key/iv/ciphertext/tag.
"""
...
def run_demo():
    print('=== AES-128 All Modes Demo ===')
    key = b'A' * 16  # 16 bytes -> AES-128
